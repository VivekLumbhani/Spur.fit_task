  ...
  return (
    <div className="relative w-full max-w-xl mx-auto">
      ...
      <div className="bg-cyan-50 py-8 px-4 rounded-lg shadow-md">
        ...
        <br />
        <div className="flex items-center justify-center">
          <div className="mr-10">Answer question on your social skills</div>
          <div className="ml-10">Let other give chances</div>
          <div className="ml-10">Find out where you and other find the same things</div>
        </div>


        <div className="bg-white rounded-lg shadow-lg p-8 mt-6">
          <div className="bg-cyan-100 h-4 w-full relative">
