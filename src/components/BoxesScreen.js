    ...
    <div className="relative w-full max-w-xl mx-auto">
      ...
      <div className="overflow-x-auto overflow-y-hidden">
        <div className="flex p-4">
          {/* First Box */}
          <div className="w-full md:w-1/2 lg:w-1/3 border rounded-lg shadow-md hover:shadow-lg-xl transition duration-300 ease-in-out transform hover:-translate-y-1 bg-gray-100 mx-2" style={{ backgroundColor: getRandomColor() }}>
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 border rounded-lg shadow-md hover:shadow-lg-xl transition duration-300 ease-in-out transform hover:-translate-y-1 bg-gray-100 mx-2" style={{ backgroundColor: getRandomColor() }}>
            ...
            <p className="text-white-700 text-base px-4 pb-4">
              You argue with a colleague lorem ipsum dolor sit amet, consectetur adipiscing elit.
            </p>
          </div>
